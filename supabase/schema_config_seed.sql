...
COMMENT ON TABLE "public"."envios" IS 'Stores individual shipment details managed by the company.';
...
-- Create Table for Envios Individuales (Client-Requested)
...
CREATE POLICY "Allow admin all for envios_individuales" ON "public"."envios_individuales" FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- Sample Data for Tarifas Distancia Calculadora (Current Date)
...
-- Sample Data for Repartidores (minimal for functionality)
...
-- Sample Data for Empresas (minimal for functionality)
INSERT INTO "public"."empresas" ("id", "nombre", "direccion", "latitud", "longitud", "estado") VALUES
('a1b2c3d4-e5f6-7890-1234-567890abcdef', 'Tech Solutions SRL', 'San Martin 123, Mar del Plata', -38.0045, -57.5426, TRUE),
('b2c3d4e5-f6a7-8901-2345-678901bcdef0', 'NUTRISABOR (Viandas)', 'Av. Independencia 456, Mar del Plata', -38.0012, -57.5501, TRUE);

-- No INSERTs for clientes, repartos, envios, paradas_reparto, envios_individuales here,
-- as this script is focused on schema and essential configuration.
-- Sample data for those can be added in a separate, more comprehensive seed file or manually.
